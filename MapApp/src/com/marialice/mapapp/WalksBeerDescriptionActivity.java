...
public class WalksBeerDescriptionActivity extends Activity {
	...
	public void createDetails() {
		...
		Intent walkbeerinfowindowintent = getIntent();
		String positionmap = walkbeerinfowindowintent.getStringExtra(String.valueOf("walkBeerPoi"));
		...
		for (int i = 0; i < dbwalkbeerpois.size(); i++) {
			...
			String positiondb = String.valueOf(beerpoi.getLatLng());
			...
			if (positiondb.equals(positionmap)) {
				...
				textViewDesc.setText(Html.fromHtml(beerpoi.getDescription()));
				textViewWalk.setText(Html.fromHtml(beerpoi.getName()));
				textViewTitle.setText(Html.fromHtml(beerpoi.getTitle()));
				textViewAddress.setText(Html.fromHtml(beerpoi.getAddress()));
