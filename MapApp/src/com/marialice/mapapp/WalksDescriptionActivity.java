...
public class WalksDescriptionActivity extends Activity {
	...
	public void createDetails() {
		...
		Intent walkinfowindowintent = getIntent();
		String positionmap = walkinfowindowintent.getStringExtra(String.valueOf("walkPoi"));
