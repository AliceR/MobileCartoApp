...
public class WalksWaterDescriptionActivity extends Activity {
	...
	public void createDetails() {
		...
		Intent walkwaterinfowindowintent = getIntent();
		String positionmap = walkwaterinfowindowintent.getStringExtra(String.valueOf("walkWaterPoi"));
		...
		for (int i = 0; i < dbwalkwaterpois.size(); i++) {
			...
			String positiondb = String.valueOf(waterpoi.getLatLng());
